...
export const profile = {
  ...
  linkedinUrl: "https://www.linkedin.com/in/preciselysheldon",
  philosophy:
  ...
  bio: [
    "Based in Atlanta, Georgia, this work is driven by a persistent question: why do well-run retail organizations still leave so much performance on the table? Not from a lack of effort, but from treating a connected system — store design, labor, customer experience, capital — as a set of unrelated initiatives to be optimized one at a time.",
